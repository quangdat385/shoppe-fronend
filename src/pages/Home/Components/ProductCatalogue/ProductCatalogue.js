...
function ProductCatalogue() {
  ...
  const [sortBy, setSortBy] = useState({
    byOrder: null,
    byPrice: null,
    byCollection: Number(byCollection)
  });
  useEffect(() => {
  ...
  useEffect(() => {
    setHomePage({ popular: sort.popular, price: sort.price, menu: menu })
  ...
  useEffect(() => {
    ...
    let byCollection = `&byCollection=${sortBy.byCollection}`;
