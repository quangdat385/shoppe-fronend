...
function AboutShop({ numberOfLikes, numberOfRates, products }) {
                ...
                <div className={cx("details-box")}>
                    <div className={cx('shop-details', "gap-3")}>
                        <div className={cx('item')}>
                            ...
                            <p className={cx("details")}>{numberOfRates < 1000 ? numberOfRates :
                                `${((numberOfRates / 1000).toFixed(2))}k`}</p>
                        </div>
                        <div className={cx('item')}>
                        ...
                        <div className={cx('item')}>
                            ...
                            <p className={cx("details")}>{timeAgo}</p>
                        </div>
                        <div className={cx('item')}>
                        ...
                        <div className={cx('item')}>
                            ...
                            <p className={cx("details")}>{numberOfLikes}</p>
                        </div>
                    </div>
                </div>
            </Col>
