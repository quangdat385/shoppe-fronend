...
function Header() {
  ...
  //     forceRefetch: true
  // });
  const query = { update: false, id: UserId }
  const { data: userInfo, isSuccess: isUserInfoSuccess } = useGetUserQuery(query, {
    pollingInterval: 60000,
    refetchOnMountOrArgChange: true,
    refetchOnFocus: true,
    forceRefetch: true
  ...
  return (
    <div className={cx('header')}>
            ...
            <Nav>
              <div className={cx('notify')}>
                <Link className={cx('nav_link')} to="/home/0/sort?&byCollection=0" >
                  <svg viewBox="3 2.5 14 14" x="0" y="0" className={cx('notify-icon')}>
                    ...
                    <path fill="white" d="m10 18c1 0 1.9-.6 2.3-1.4h-4.6c.4.9 1.3 1.4 2.3 1.4z">
                    </path>
                  </svg>
                  Thông Báo

                </Link>
                <Container fluid className={cx("my-notify", "bg-transparent border-0 shadow-none ")}>

                  <div className={cx("my-notify-content")}>
                    {(user && notifications.length > 0) ?
                      <div className={cx("have-user")} >
                            ...
                            <Link className={cx("notify-list__link")} to="/home/0/sort?&byCollection=0" >
                              ...
                              <div className={cx("notify-info")}>
                                <span className={cx("notify-name")}>
                                  Kem chống nắng Whoo Essential Sun Cream
                                </span>
                                <span className={cx("notify-description")}>
                                  Hàng chính hãng chất lượng ngon bổ rẻ
                                </span>
                              </div>
                            </Link>
                          </div>
                          <div className={cx("notify-list__item")}>
                        ...
                        <footer className={cx("notify-footer")}>
                          <Link className={cx("notify-footer__btn")} >Xem tất cả</Link>
                        </footer>

                      </div> :
                      <>
                        <div className={cx("no-user")}>
                          <div className={cx("no-user__img")}>
                            <img className={cx("img")} src={notify} alt="Thông Báo" />
                          </div>
                          <div className={cx("no-user__text")}>Chưa có thông báo mới</div>
                        </div>

                        {!user && <div className={cx("no-user-footer", "d-flex ")}>
                          <Button
                            as={Link}
                            to="/signup"
                            className='w-50 rounded-0 fs-4 fw-light '
                            variant="light"
                          >
                            Đăng Nhập
                          </Button>
              ...
              <Link to="/home/0/sort?&byCollection=0" className={cx('help', 'nav_link')}  >
                <svg height="16" viewBox="0 0 16 16" width="16" className={cx('help-icon')}>
                  <g fill="none" fillRule="evenodd" transform="translate(1)">
                    ...
                    <path fill="white" d="m6.871 3.992c-.814 0-1.452.231-1.914.704-.462.462-.693 1.089-.693 1.892h1.155c0-.484.099-.858.297-1.122.22-.319.583-.473 1.078-.473.396 0 .715.11.935.33.209.22.319.517.319.902 0 .286-.11.55-.308.803l-.187.209c-.682.605-1.1 1.056-1.243 1.364-.154.286-.22.638-.22 1.045v.187h1.177v-.187c0-.264.055-.506.176-.726.099-.198.253-.396.462-.572.517-.451.825-.737.924-.858.275-.352.418-.803.418-1.342 0-.66-.22-1.188-.66-1.573-.44-.396-1.012-.583-1.716-.583zm-.198 6.435c-.22 0-.418.066-.572.22-.154.143-.231.33-.231.561 0 .22.077.407.231.561s.352.231.572.231.418-.077.572-.22c.154-.154.242-.341.242-.572s-.077-.418-.231-.561c-.154-.154-.352-.22-.583-.22z">
                    </path>
                  </g>
                </svg>
                Trợ Giúp
              ...
              {user ? (
                <div className={cx('user')}>
                  <Link className={cx("nav_link")} to="/user/profile">
                    <Avatar
                      className={cx("avatar",)}
                      user={user ? user : null}
                      src={currentUser?.avatar ?
                        `${process.env.REACT_APP_API_IMG_URL}/avatar/${currentUser?.avatar[0]}`
                        : null}
                    />
                  ...
                  <div className={cx("user-menu-wrapper")}>
                    <div className={cx("user-menu-list")}>
                      <Link className={cx("user-menu-item")} to="/user/profile">Tài Khoản Của Tôi</Link>
                      <Link className={cx("user-menu-item")} to="/user/order/list?status=0">Đơn Mua </Link>
                      <Link className={cx("user-menu-item")} onClick={sendLogout}>Đăng Xuất </Link>
                    </div>
                  </div>

                </div>
              ) : <>
                <Link className={cx('sign-up', 'nav_link', 'nav_link--after')} to="/signup"  >Đăng Ký</Link>
                <Link className={cx('login', 'nav_link')} to="/login" >Đăng Nhập</Link>
              </>
              }
            </Nav>
          </Navbar.Collapse>
      ...
      <Container className={cx('search')}>
        <Row className={cx('search-box')}>
          <Col
          ...
          >
            <Link className={cx('to-home')} to="/home/0/sort?&byCollection=0">
                            ...
                            <g transform="translate(-1016 -32)"><g>
                              <g transform="translate(405 21)">
                                <g transform="translate(611 11)">
                                  ...
                                  <path fill="white" d="m12.2972351 13.7114222 4.9799555 4.919354c.3929077.3881263 1.0260608.3842503 1.4141871-.0086574.3881263-.3929076.3842503-1.0260607-.0086574-1.414187l-4.9799554-4.919354c-.3929077-.3881263-1.0260608-.3842503-1.4141871.0086573-.3881263.3929077-.3842503 1.0260608.0086573 1.4141871z">
                                  </path>
                                </g>
                              </g>
                            </g>
          ...
          <Col xl={2} lg={1} sm={2} xs={3} >
            <div className={cx("shopping-cart")}>
              ...
              <Link className={cx("shopping-cart-link")} to='/user/cart'>
                <svg viewBox="0 0 26.6 25.6" className={cx("icon-shopping-cart")}>
                  <polyline fill="none" points="2 1.7 5.5 1.7 9.6 18.3 21.2 18.3 24.6 6.1 7 6.1" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5">
                  </polyline>
                ...
                {user && order?.length > 0 && <div className={cx("number-of-orders")}>{order?.length > 0 ? order?.length : null}</div>}
                <div className={cx("notify-cart-wrapper")}>
                  {
                    user && order?.length > 0 ? <NotifyCart order={order} /> : <EmtyOrder />
                  }
                </div>
