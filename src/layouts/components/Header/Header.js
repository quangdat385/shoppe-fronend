        ...
        <div className={cx('header')}>
                                        ...
                                        {user ?
                                            <div className={cx("have-user")} >
                                                ...
                                                <div className={cx("no-user")}>
                                                    ...
                                                    <div className={cx("no-user__text")}>Đăng nhập để xem thông báo</div>
                                                </div>
                                                <div className={cx("no-user-footer", "d-flex ")}>
                                                    <Button
                                                        as={Link}
                                                        to="/signup"
                                ...
                                <div className={cx('user')}>
                                    <Link className={cx("nav_link")} to="/user/profile">
                                        <Avatar
                                            ...
                                            src={currentUser?.avatar ?
                                                `${API_IMG_URL}/avatar/${currentUser?.avatar[0]}`
                                                : null}
                                        />
                                    ...
                                    <div className={cx("user-menu-wrapper")}>
                                        <div className={cx("user-menu-list")}>
                                            ...
                                            <Link className={cx("user-menu-item")} to="/user/order/list">Đơn Mua </Link>
            ...
            <Container className={cx('search')}>
                <Row className={cx('search-box')}>
                    ...
                    >
                        <Link className={cx('to-home')} to="/home">
